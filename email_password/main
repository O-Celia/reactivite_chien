...
import models
from routes import user, trigger, reaction, entry, search, password_reset
...
app.include_router(password_reset.password_router, prefix="/password-reset", tags=["password"])
