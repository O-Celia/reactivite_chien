...
from schemas.reaction import ReactionBase, ReactionRead, ReactionUpdate, CloneRequest
...
def create_reaction(
    ...
    return crud_reaction.create_reaction(
...
def update_reaction(
    reaction_id: int, reaction_update: ReactionUpdate, db: Session = Depends(get_db)
):
